$(document).ready(function () {
    ...
    $("#save").omButton({icons: {left: '/medias/style/plat/image/button/accept.gif'}}).click(function () {
        if (pro) {
            for (var key in eles) {
                var e = eles[key];
                var v = "";
    ...
    $("#cancel").omButton({icons: {left: '/medias/style/plat/image/button/cancel.png'}}).click(function () {
        _top.property = null;
