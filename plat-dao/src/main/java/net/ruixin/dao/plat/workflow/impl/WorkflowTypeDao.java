...
public class WorkflowTypeDao extends BaseDao<SysWorkflowType> implements IWorkflowTypeDao {
    ...
    public List<SysWorkflowType> findByParent(Long id) {
        return super.findListByHql("from SysWorkflowType t where t.parentId = ? and t.sfyx_st = '1'", id);
    }

    @Override
    public List<SysWorkflowType> findTops() {
        return super.findListByHql("from SysWorkflowType t where (t.parentId is null or t.parentId = 1) and t.sfyx_st = '1' order by id asc");
    }
