...
public interface IResourceDao {
     ...
     * 角色资源异步树数据获取
     */
    List getRoleResourceTreeData(String type, Long roleId, String showRoleIds, Boolean showAll);

    /**
     * 保存角色资源关联
     */
    void saveRoleResource(Long roleId, String resourceIds, Long cjrId);
}
