...
function limit() {
    ...
    function wordsLimit() {
        var noteCount = 0;
        if (isbyte) {
            noteCount = txtNote.value.replace(/[^\x00-\xff]/g, "**").length
        } else {
...
//        });
    ...
    window.forms = {
        clearNoNumAndD: function (obj) {
            ...
            var result = "";
            $.ajax({
                url: "findBusinessClass",
                data: {cid: cid || "", did: did, name: name || "", random: Math.random(100)},
                async: false,
            ...
            $.ajax({
                url: "findClassData",
                data: {cid: cid, did: did, field: field},
            ...
            data.vid = vid;
            $.ajax({
                url: "getViewData", data: data, async: typeof callback == 'function', success: function (data) {
                    result = data;
                    if (typeof callback == 'function') {
                        callback($.parseJSON(data));
                    }
            ...
            var result = "";
            $.ajax({
                url: "getWfNameById", data: {cid: cid, did: did, name: field}, async: false, success: function (data) {
                    result = data;
                }
            });
            return result;
            ...
            var result = "";
            $.ajax({
                url: "findDeepBusinessClass",
                data: {cids: cids, did: did, fields: fields, name: name},
                async: false,
                success: function (data) {
                    result = data;
                }
