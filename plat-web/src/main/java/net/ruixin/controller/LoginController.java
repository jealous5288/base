...
public class LoginController extends BaseController {
    ...
    public String loginVali(ServletRequest request, ServletResponse response) throws IOException {
...
//        getSession().setAttribute("userMenus", menuService.getUserMenus(shiroUser.getId(),shiroUser.getSfwhgxcd()));
        getSession().setAttribute("userMenus", menuService.getMenus(shiroUser.getId()));
        return REDIRECT + "/";
    }
